...
button.glyphicon.glyphicon-comment.btn-lg {
	position: fixed;
	height: 45px;
	top: 696px;
	left: 57%;
...
<link rel="stylesheet" type="text/css"
	href="/resources/css/colorboxcss.css">

<link rel="stylesheet" type="text/css"
	href="/resources/css/imageOverlay.css">
...
<body style="overflow-x: hidden; overflow-y: auto;">
	...
	<div class="wrapper" id="makersBackground">
		...
		<nav id="sidebar">
			...
			<ul class="list-unstyled components">
				...
				<li class="active"><a href="/user/login">Home</a></li>
				<li><a id="MyPageBtn" class="btn btn-primary"
					data-toggle="modal" data-target="#myPageModal"> My Page </a></li>
				<li><a href="/sboard/listPage">My Home</a></li>

				<li><a href="#pageSubmenu" data-toggle="collapse"
					aria-expanded="false">Chat</a>
					<ul class="collapse list-unstyled" id="pageSubmenu">
						<li><a href="/user/login">개인 채팅</a></li>
						<li><a href="/user/login">우리 동 채팅</a></li>
					</ul></li>

				<li><a href="#pageSubmenu1" data-toggle="collapse"
					aria-expanded="false">Service Center</a>
					<ul class="collapse list-unstyled" id="pageSubmenu1">
						<li><a href="/snboard/listPage">Notice</a></li>
						<li><a href="/qnaboard/listPage">Q&A</a></li>
					</ul></li>
				...
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h3 class="modal-title" id="exampleModalLongTitle">Insert
								Your Password</h3>
						...
						<div class="modal-body">
							<form action="/user/myPage" method="post" id="frm">
								<input type="password" name="upw"
									style="width: 560px; height: 45px; font-size: 18px;">
							</form>
						</div>
						<div class="modal-footer">
							...
							<button type="button" class="btn btn-primary" id="postBtn"
								onclick="document.getElementById('frm').submit();">Post</button>
						</div>
					</div>
				</div>
			</div>
							...
							<div class="box-header" id="box_header">
								...
								<div id="profilePhoto1">
									<img src="/resources/image/image1.jpg" id="propilePhoto"
										onclick="profilePhotoUp()" />&nbsp;&nbsp;
								</div>
								<div id="profileId">
									<h3 class="box-title"
										style="font-size: 30px; font-weight: 100;">eok_10000000000000</h3>
								</div>
							...
							<c:forEach items="${list}" var="snsBoardVO">
								<div class="containerOverlay">
								  <div class="contentOverlay">
								    <a href="#test${snsBoardVO.bno}Content"
									class="group-cbox1 inline" title="${snsBoardVO.title}" target="_blank" >
								      <div class="content-overlay"></div>
								      <span class="uploadedList2${snsBoardVO.bno}" style="width: 380px;" /></span>
								      <div class="content-details fadeIn-bottom">
								        <h3 class="glyphicon glyphicon-heart" aria-hidden="true">${snsBoardVO.likecnt}</h3>
								        <h3 class="glyphicon glyphicon-comment" aria-hidden="true">${snsBoardVO.replycnt}</h3>
								      </div>
								    </a>
								  </div>
								</div>
								...
								<div style='display: none'>
									<div id="test${snsBoardVO.bno}Content"
										...
										<div class="media">
											...
											<div class="hd">
												<h3>${snsBoardVO.writer}</h3>
											</div>
											<div class="bd">
												<p class="p-inner-window">${snsBoardVO.content}</p>
												<br> <br> <a href="#blue" class="loadClass"
													id="load${snsBoardVO.bno}"
													onclick="loadRepl(${snsBoardVO.bno})" style="color: white;">Load
													More</a>
												<!-- The time line -->
												<ul id="timelineUl" class="timeline${snsBoardVO.bno}">
													<!-- timeline time label -->
													<li id="repliesDiv${snsBoardVO.bno}" style="color: white;"></li>
												</ul>

												<!-- 하트, 대화상자 -->
												<div class="box-header with-border" align="left"
													id="likechatbox${snsBoardVO.bno}">
													<label for="exampleInputEmail1" id="likeform"><strong>좋아요
															${snsBoardVO.likecnt}개</strong></label>

													<div id='heart' class='button' style="height: 40px;"
														onclick="like_func(${snsBoardVO.bno})"></div>
												...
												<div id="modifyModal${snsBoardVO.bno}"
													class="modal modal-primary fade" role="dialog">
														...
														<div class="modal-content">
															...
															<div class="modal-footer">
																<button type="button" class="btn btn-info"
																	id="replyModBtn" data-dismiss="modal">Modify</button>
			...
			$(document).ready(
					function() {
						...
						$('#searchBtn').on("click", function(evt) {
							self.location = "/snsboard/profile"
	...
	<script id="templateAttach4" type="text/x-handlebars-template">
			<img src="{{imgsrc}}"/>
	</script>
	...
	<!--댓글 템플릿 코드 -->
			...
			<script id="templateAttach3" type="text/x-handlebars-template">
						<div class="containerOverlay">
								  <div class="contentOverlay">
								    <a href="#test{{Bno}}Content"
									class="group-cbox1 inline" title="{{Title}}" target="_blank" >
								      <div class="content-overlay"></div>
								      <span class="uploadedList2{{Bno}}" style="width: 380px;" /></span>
								      <div class="content-details fadeIn-bottom">
								        <h3 class="glyphicon glyphicon-heart" aria-hidden="true">{{Likecnt}}</h3>
								        <h3 class="glyphicon glyphicon-comment" aria-hidden="true">{{Replycnt}}</h3>
								      </div>
								    </a>
								  </div>
								</div>
									...
									<div id="test{{Bno}}Content"
										...
										<div class="media">
											...
											<ul class="slides">
												...
												<li class="nav-dots"><label
													class="uploadedListLabel{{Bno}}"></label></li>
											</ul>
											<!-- 사진 나오는곳 끝 -->
											...
											<div class="bd">
												<p class="p-inner-window">{{Content}}</p>
												<br> <br>
											<a href="#blue" class="loadClass" id="load{{Bno}}"
												onclick="loadRepl({{Bno}})" style="color: white;">Load More</a>
												<!-- The time line -->
											<ul id="timelineUl" class="timeline{{Bno}}" >
												<!-- timeline time label -->
												<li id="repliesDiv{{Bno}}" style="color: white;"></li>
											</ul>

											<!-- 하트, 대화상자 -->
											<div class="box-header with-border" align="left"
												id="likechatbox{{Bno}}">
												<div id='heart' class='button' style="height: 40px;" onclick="like_func({{Bno}})"></div>
												<button class="glyphicon glyphicon-comment btn-lg"
													onclick="newReplyText{{Bno}}.focus();"
													id="replybtn7"></button>
											</div>
											<!-- 하트, 대화상자 -->											
											...
											<div id="modifyModal{{Bno}}" class="modal modal-primary fade"
												role="dialog">
												<div class="modal-dialog">
													<!-- Modal content -->
													<div class="modal-content" >
														...
														<div class="modal-body" data-rno>
															<p>
																<input type="text" id="replytext{{Bno}}"
																	class="form-control">
															</p>
														</div>
														<div class="modal-footer">
	...
	<!-- 무한 스크롤 템플릿 코드 -->
			...
			<c:forEach items="${list}" var="snsBoardVO" step="1">
				...
				var template4 = Handlebars.compile($("#templateAttach4").html());
				...
				$.ajax({
					...
					success: function (data) {
						...
						$(data).each(function () {
							...
							if(i==1){
								var html4 = template4(fileInfo);
								$(".uploadedList2${snsBoardVO.bno}").append(html4);
							}					
			...
			<script type="text/javascript">
				...
				$(window).scroll(function() {
				    if ($(window).scrollTop() == $(document).height() - $(window).height() && countList > page) {
				    	var loginID = "${whoProfileId}";
				    	page = page + 12 ;
				    	perPageNum = perPageNum;
						$.ajax({
						url: '/snsboard/listAdd',
						data: "page="+page+"&perPageNum="+perPageNum+"&uid="+loginID,
						dataType:"JSON",
						type: 'GET',
						success: function (data) {
						...
						complete: function (data) {
							ContentMore();
							$('head').append('<script src=\'/resources/js/colorbox.js\'><\/script>');	// 컬러박스 자바스크립트 reload
						}
					...
					$.ajax({
						...
						success: function (data) {
							...
							$(data).each(function () {
								...
								if(i==1){
									var html4 = template4(fileInfo);
									$(".uploadedList2"+bno).append(html4);
								}	
								var html = template(fileInfo);
								var html2 = template2(fileInfo);
