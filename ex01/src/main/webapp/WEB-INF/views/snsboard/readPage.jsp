...
<script type="text/javascript" src="/resources/js/upload.js"></script>
		...
		<form role="form" method="post">
			<input type="hidden" name="bno" value="${snsBoardVO.bno}">
		...
		<div class="box-body">
			...
			<div class="form-group">
				...
				readonly="readonly">${snsBoardVO.content}</textarea>
			</div>
			<div class="form-group">
				<label for="exampleInputEmail1">Writer</label>
				<input type="text" name="writer" class="form-control" value="${snsBoardVO.writer}"
					readonly="readonly">
			</div>
		</div>
		...
		<c:if test="${login.uid == snsBoardVO.writer}">
		...
		<ul >
			...
			<li  id="repliesDiv">
				<span class="bg-green">
					Replies List <small id="replycntSmall">[ ${snsBoardVO.replycnt} ]</small>
				</span></li>
		</ul>
...
<script type="text/javascript">
	...
	$(".pagination").on("click", "li a", function (event) {
		...
		getPage("/snsreplies/"+bno+"/"+replyPage);
	});
	...
	$.getJSON("/snsboard/getAttach/"+bno, function (list) {
		$(list).each(function () {
