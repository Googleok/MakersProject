...
<script type="text/javascript" src="/resources/js/upload.js"></script>
		...
		<div class="box-body">
			...
			<div class="form-group">
				...
				readonly="readonly">${noticeBoardVO.content}</textarea>
			</div>
			<div class="form-group">
		...
		<c:if test="${login.uid == noticeBoardVO.writer}">
		...
		<ul class="timeline">
			...
			<li class="time-label" id="repliesDiv">
				<span class="bg-green">
					Replies List <small id="replycntSmall">[ ${noticeBoardVO.replycnt} ]</small>
				</span></li>
		</ul>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#modifyBtn").on("click", function() {
			...
			formObj.attr("action", "/snboard/modifyPage");
			formObj.submit();
		});
		...
		$("#listBtn").on("click", function() {
			formObj.attr("method", "get");
			formObj.attr("action", "/snboard/listPage");
			formObj.submit();
		});
...
<script type="text/javascript">
	...
	$(".pagination").on("click", "li a", function (event) {
		...
		getPage("/snreplies/"+bno+"/"+replyPage);
	});
