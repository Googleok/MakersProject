...
<script type="text/javascript" src="/resources/js/upload.js"></script>
		...
		<form role="form" method="post">
			<input type="hidden" name="bno" value="${qnaBoardVO.bno}">
		...
		<div class="box-body">
			<div class="form-group">
				...
				<input type="text" name="title" class="form-control" value="${qnaBoardVO.title}"
					readonly="readonly">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="text" name="writer" class="form-control" value="${qnaBoardVO.writer}"
					readonly="readonly">
			</div>
		</div>
		...
		<c:if test="${login.uid == qnaBoardVO.writer}">
		...
		<c:if test="${login.uid == qnaBoardVO.writer || login.uid == 'admin'}">
		<div class="row">
			<div class="col-md-12">
				<div class="box box-success">
					...
					<div class="box-body">
						<label for="exampleInputEmail1" id="qnawriter1">Writer</label>
						<input class="form-control" type="text" placeholder="USER ID" id="newReplyWriter"
						value="${login.uid}" readonly="readonly">
						<label for="exampleInputEmail1" id="qnawriter2">Reply Text</label>
						<input class="form-control" type="text" placeholder="Reply Text" id="newReplyText" onkeyup="enterkey();">
					</div>
					<!-- /.box body -->
					<div class="box-footer">
		...
		<ul class="timeline">
			...
			<li class="time-label" id="repliesDiv">
				<span class="bg-green">
					Replies List <small id="replycntSmall">[ ${qnaBoardVO.replycnt} ]</small>
				</span></li>
		</ul>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#listBtn").on("click", function() {
			formObj.attr("method", "get");
			formObj.attr("action", "/qnaboard/listPage");
			formObj.submit();
		});
...
<script type="text/javascript">
	...
	$(".pagination").on("click", "li a", function (event) {
		...
		getPage("/qnareplies/"+bno+"/"+replyPage);
	});
