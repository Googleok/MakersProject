...
<div class="box-body">
	...
	<div class="form-group" id="bnoDiv">
		<label for="exampleInputEmail1">BNO</label>
		<input type="text" name="bno" class="form-control" value="${qnaBoardVO.bno}"
			readonly="readonly">
	</div>
	...
	<div class="form-group" id="contentDiv">
		...
		<textarea rows="3" class="form-control" name="content">${qnaBoardVO.content}</textarea>
	</div>
	
	<div class="form-group" id="writerDiv">
		<label for="exampleInputEmail1">Writer</label>
		<input type="text" name="writer" class="form-control" value="${qnaBoardVO.writer}" readonly="readonly">
	</div>
	
	<div class="form-group" id="filedropDiv">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$(".btn-warning").on("click", function() {
			self.location = "/qnaboard/listPage?page=${cri.page}&perPageNum=${cri.perPageNum}"
