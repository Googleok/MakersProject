...
$(function () {
	...
	$(".group-cbox1").colorbox({ rel: 'group-cbox1', transition: "elastic", width: "1500px", height: "700px", position:"absolute", fixed: "false"});

	$(".inline").colorbox({ inline: true, width: "1500px" });
